...
if __name__ == "__main__":
    ...
    demo_role = os.environ.get("AGS_ROLE_ARN")
    if not demo_role:
        raise SystemExit(
            "Please set AGS_ROLE_ARN to a valid role (e.g. "
            "'qcs::cam::uin/<uin>:roleName/<name>') that grants image-pull "
            "permissions for the custom image."
        )
    ...
    started = start_custom(
        ...
        resources={"CPU": "1000m", "Memory": "500Mi"},
        probe={
            "HttpGet": {"Path": "/", "Port": 49983, "Scheme": "HTTP"},
