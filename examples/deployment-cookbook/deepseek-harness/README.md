...
- [brain-hands](./brain-hands/README.md) runs multiple stateless Brain replicas with MySQL-backed DSH sessions and separate E2B/envd Hands instances whose complete filesystems are retained by AGS.
